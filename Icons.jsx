/* Icons.jsx — Lucide line icons (1.75px stroke) as React components.
   Paths sourced from lucide.dev. */
const _LUCIDE = {
  ...
  signal: '<path d="M4 11a9 9 0 0 1 9 9"/><path d="M4 4a16 16 0 0 1 16 16"/><circle cx="5" cy="19" r="1"/>',
  ...
  /* --- added for fintech / mobile / freelance --- */
...
function Icon({ name, size = 20, stroke = 1.75, className = '', style = {} }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size}
      ...
      dangerouslySetInnerHTML={{ __html: _LUCIDE[name] || '' }} />
  );
}
